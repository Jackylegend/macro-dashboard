...
import pandas as pd
import numpy as np
from dataloader import mkt_index_data
import plotly.express as px


index_daily, index_weekly, index_monthly = mkt_index_data()
freq = ['Daily','Weekly', 'Monthly']
indices = ['S&P 500', 'DJIA','Russell 2000','Nasdaq 100','Nasdaq Composite','VIX']
...
table['Ticker'] = table['Ticker'].replace({'^GSPC': 'S&P 500', '^DJI': 'DJIA', '^IXIC': 'Nasdaq Composite','^NDX':'Nasdaq 100', '^RUT':'Russell 2000','^VIX': 'VIX'})
...
if selection:
    ...
    fig.update_layout(yaxis=dict(tickformat=".2%",linecolor='black', linewidth=2, dtick = 0.025),
                        xaxis=dict(tickangle=-45,linecolor='black', linewidth=1))
